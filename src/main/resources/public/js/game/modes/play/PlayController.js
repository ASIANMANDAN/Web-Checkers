...
define(function(require){
  ...
  // PLAY mode states
  var PlayModeStartState = require('./PlayModeStartState');
  var EmptyTurnState = require('./EmptyTurnState');
  var ValidatingMoveState = require('./ValidatingMoveState');
  var StableTurnState = require('./StableTurnState');
  var RequestingBackupMove = require('./RequestingBackupMove');
